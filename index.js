...
function setVideoInfo(e) {
    ...
    VideoInfo.info.countries.href = e.material_data.countries?`${window.location.origin + window.location.pathname}?countries=${e.material_data.countries ? e.material_data.countries : "404.htm"}`:"404.htm";
    ...
    VideoInfo.info.info_status.href = e.material_data.anime_status?`${window.location.origin + window.location.pathname}?anime_status=${e.material_data.anime_status ? e.material_data.anime_status : "404.htm"}`:"404.htm";

    VideoInfo.info.studios.textContent = e.material_data.anime_studios ? e.material_data.anime_studios : "?";
    VideoInfo.info.studios.href = e.material_data.anime_studios?`${window.location.origin + window.location.pathname}?anime_studios=${e.material_data.anime_studios ? e.material_data.anime_studios : "404.htm"}`:"404.htm";

    VideoInfo.info.year.textContent = e.material_data.year ? e.material_data.year : "?";
    VideoInfo.info.year.href = e.material_data.year?`${window.location.origin + window.location.pathname}?year=${e.material_data.year ? e.material_data.year : "404.htm"}`:"404.htm";

    VideoInfo.info.rating_mpaa.textContent = e.material_data.rating_mpaa ? e.material_data.rating_mpaa : "?";
    VideoInfo.info.rating_mpaa.href = e.material_data.rating_mpaa?`${window.location.origin + window.location.pathname}?rating_mpaa=${e.material_data.rating_mpaa ? e.material_data.rating_mpaa : "404.htm"}`:"404.htm";
    ...
    VideoInfo.info.shikimori_link.href = e.shikimori?`https://shikimori.one/animes/${e.shikimori ? e.shikimori : "404.htm"}`:"404.htm";
    ...
    VideoInfo.info.IMDB_link.href = e.imdb?`https://www.imdb.com/title/${e.imdb ? e.imdb : "404.htm"}`:"404.htm";
