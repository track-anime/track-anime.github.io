...
function setVideoInfo(e) {
    ...
    if(VideoInfo.info.cover.src.includes("missing_original.jpg")) VideoInfo.info.cover.src = "pedro.gif"
...
function add_cart(e) {
    ...
    if(e.cover.includes("missing_original.jpg")) e.cover = "pedro.gif"
